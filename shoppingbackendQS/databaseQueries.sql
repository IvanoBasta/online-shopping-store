...
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDUN75NU8000', 'Samsung UN75NU8000', 'samsung', 'This is one of the best tv available in market', 146000, 5, true, 1, 2, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRD52A0B370E4', 'TESTIRANJE', 'test', 'test', 50, 0, true, 1, 2, 0, 0 );
